...
def run_game():
    ...
    while (keepGoing):
        ...
        pygame.draw.rect(my_win, pygame.color.Color('white'), (100,100,50+frame_num,50))
        pygame.draw.rect(my_win, pygame.color.Color('darkmagenta'), (140,140,70+frame_num,40+frame_num))
        ...
        pygame.draw.circle(my_win, pygame.color.Color('navy'), (width-75-frame_num, height-75-frame_num),75)
        if (RedRadius < 0):
            RedRadius = 75
        pygame.draw.circle(my_win, pygame.color.Color('red'), (EndpointX-2*frame_num, EndpointY), RedRadius)
        ...
        pygame.draw.polygon(my_win,pygame.color.Color('darkgreen'), \
                            [(150-frame_num,300-frame_num),(150+120+frame_num,300-frame_num),(150+60,300+120+frame_num)])
